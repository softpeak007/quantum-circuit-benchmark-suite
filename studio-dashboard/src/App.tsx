...
export default function App() {
  ...
  // Mobile parameters drawer toggle
...
st.info("Check requirements.txt and run pip install qiskit streamlit plotly")`;
  ...
  const renderSidebarContent = () => {
    return (
      <div className="flex flex-col gap-6">
        ...
        <div className="backdrop-blur-xl bg-white/[0.02] p-5 sm:p-6 rounded-3xl border border-white/[0.06] flex flex-col gap-6 shadow-[0_4px_30px_rgba(0,0,0,0.4)] relative overflow-hidden group">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-slate-350 text-xs font-semibold flex items-center justify-between">
              <span>Quantum Logic Target</span>
              <span className="text-[10px] text-slate-500 font-mono font-bold">Algorithm</span>
            </label>
            <div className="relative">
              <select
                value={selectedCircuit}
                onChange={(e) => setSelectedCircuit(e.target.value)}
                className="w-full bg-[#030508] border border-white/[0.08] text-slate-255 text-xs rounded-xl p-3 h-[48px] focus:ring-1 focus:ring-cyan-500/50 focus:border-cyan-500/50 outline-none transition cursor-pointer font-sans"
              >
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-between items-center text-sm">
              <span className="text-slate-350 font-semibold text-xs">Qubits Count (N)</span>
            ...
            <div className="grid grid-cols-5 gap-2 mt-1">
              {[2, 4, 6, 8, 10].map((num) => (
                <button
                  ...
                  className={`h-11 sm:h-12 rounded-xl text-xs font-bold font-mono transition-all border cursor-pointer flex items-center justify-center ${
                    selectedQubits === num
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-between items-center text-sm">
              <span className="text-slate-350 font-semibold text-xs">Optimization Intensity</span>
            ...
            <div className="p-3 bg-white/[0.01] rounded-xl border border-white/[0.03] text-[10px] text-slate-400 mt-1 select-none leading-relaxed min-h-[44px]">
          ...
          <button
            ...
            disabled={isRunning}
            className="w-full h-12 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 hover:from-cyan-300 hover:to-purple-500 text-slate-950 rounded-2xl text-xs font-bold tracking-widest uppercase transition-all duration-300 transform active:scale-95 flex items-center justify-center gap-2 shadow-[0_4px_20px_rgba(6,182,212,0.25)] hover:shadow-[0_4px_25px_rgba(6,182,212,0.4)] disabled:opacity-50 mt-2 cursor-pointer"
          >
            {isRunning ? (
              <>
  ...
  return (
    <div className="min-h-screen bg-[#05070A] text-slate-100 font-sans selection:bg-cyan-500 selection:text-slate-950 relative overflow-x-hidden">
      ...
      <header className="border-b border-white/[0.05] bg-[#000000]/85 backdrop-blur-xl sticky top-0 z-50 px-4 sm:px-6 py-3 sm:py-4">
        <div className="max-w-[1500px] mx-auto flex items-center justify-between">
          
          {/* Logo Brand Segment */}
          <div className="flex items-center gap-2.5">
            <div className="relative w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center bg-gradient-to-tr from-cyan-500/10 to-purple-500/10 rounded-xl border border-white/[0.08] shadow-[0_0_15px_rgba(6,182,212,0.15)] overflow-hidden group">
              ...
              <Compass className="w-4 h-4 sm:w-5 sm:h-5 text-cyan-400 rotate-45 group-hover:scale-110 group-hover:rotate-90 transition-all duration-500" />
            </div>
            <div>
              <div className="flex items-center gap-1.5">
                <span className="text-[8px] sm:text-[9px] uppercase tracking-widest font-bold px-1.5 py-0.5 rounded bg-cyan-500/10 text-cyan-400 border border-cyan-500/20">Studio</span>
                <span className="flex items-center gap-1 text-[8px] sm:text-[9px] text-emerald-400 font-mono">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-ping"></span>
                  Active Node
                </span>
              </div>
              <h1 className="text-xs sm:text-md font-bold text-white tracking-tight flex items-center gap-1 mt-0.5 font-display">
                QCBS <span className="text-slate-500 font-light">|</span> 
                <span className="text-slate-300 font-medium hidden sm:inline">Quantum Circuit Benchmark Suite</span>
                <span className="text-slate-350 font-medium sm:hidden">Quantum Studio</span>
              </h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              type="button"
              className="lg:hidden flex items-center justify-center p-2.5 rounded-lg bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-500/20 text-cyan-400 transition-all cursor-pointer"
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="flex items-center gap-2 px-3 sm:px-3.5 py-2 rounded-lg bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.05] text-xs font-semibold text-slate-350 transition-all hover:text-white"
            >
      ...
      <section className="px-4 sm:px-6 pt-6 sm:pt-10 pb-6 sm:pb-8 max-w-[1500px] mx-auto relative border-b border-white/[0.03]">
        <div className="text-center max-w-2xl mx-auto mb-6 sm:mb-8">
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.5 }}
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-cyan-500/5 border border-cyan-500/15 text-xs text-cyan-400 mb-3 sm:mb-4"
          >
            <Sparkles className="w-3.5 h-3.5 animate-pulse" />
            <span>AI-Driven Transpilation Analysis Dashboard</span>
          </motion.div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[46px] font-bold tracking-tight text-white mb-2 leading-tight font-display">
            AI-Powered Quantum Circuit Benchmark Suite
          </h2>
          <p className="text-slate-450 text-xs sm:text-sm md:text-base font-light tracking-wide italic">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
          ...
          <div className="backdrop-blur-xl bg-white/[0.02] border border-white/[0.05] p-4 sm:p-5 rounded-2xl flex flex-col justify-between group hover:border-cyan-500/40 hover:bg-white/[0.03] transition-all duration-300">
            <div>
              <span className="text-[10px] text-slate-500 font-mono tracking-widest uppercase block font-bold">Total Benchmarks</span>
              <span className="text-2xl sm:text-3xl font-bold text-white font-mono block mt-2 group-hover:text-cyan-400 transition-colors">
                {stats.count + 52}
              </span>
            </div>
          ...
          <div className="backdrop-blur-xl bg-white/[0.02] border border-white/[0.05] p-4 sm:p-5 rounded-2xl flex flex-col justify-between group hover:border-indigo-500/40 hover:bg-white/[0.03] transition-all duration-300">
            <div>
              <span className="text-[10px] text-slate-500 font-mono tracking-widest uppercase block font-bold">Average Depth</span>
              <span className="text-2xl sm:text-3xl font-bold text-cyan-400 font-mono block mt-2">
          ...
          <div className="backdrop-blur-xl bg-white/[0.02] border border-white/[0.05] p-4 sm:p-5 rounded-2xl flex flex-col justify-between group hover:border-purple-500/40 hover:bg-white/[0.03] transition-all duration-300">
            <div>
              <span className="text-[10px] text-slate-500 font-mono tracking-widest uppercase block font-bold">Highest T Count</span>
              <span className="text-2xl sm:text-3xl font-bold text-purple-400 font-mono block mt-2">
                {stats.maxT}
              </span>
            </div>
          ...
          <div className="backdrop-blur-xl bg-white/[0.02] border border-white/[0.05] p-4 sm:p-5 rounded-2xl flex flex-col justify-between group hover:border-amber-500/40 hover:bg-white/[0.03] transition-all duration-300">
            <div>
              <span className="text-[10px] text-slate-500 font-mono tracking-widest uppercase block font-bold">Highest CX Count</span>
              <span className="text-2xl sm:text-3xl font-bold text-amber-500 font-mono block mt-2">
                {stats.maxCX}
              </span>
            </div>
          ...
          <div className="backdrop-blur-xl bg-white/[0.02] border border-white/[0.05] p-4 sm:p-5 rounded-2xl flex flex-col justify-between group hover:border-emerald-500/40 hover:bg-white/[0.03] transition-all duration-300 col-span-1 sm:col-span-2 lg:col-span-1">
            <div>
              <span className="text-[10px] text-slate-500 font-mono tracking-widest uppercase block font-bold">Engine Version</span>
              <span className="text-md sm:text-lg font-bold text-emerald-400 font-mono block mt-3 flex items-center gap-1.5">
      ...
      <main className="max-w-[1500px] mx-auto px-4 sm:px-6 py-6 sm:py-8 pb-32 lg:pb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          {/* 1. SIDEBAR controls panel (Col span 4) - Hidden on mobile/tablet */}
      ...
      {/* 🔮 Floating Action Button for Quick Transpilation (Mobile UI) */}
      <div className="fixed bottom-24 right-5 z-40 lg:hidden">
        <motion.button
          ...
          disabled={isRunning}
          className="flex items-center gap-2 px-4 py-3 bg-gradient-to-r from-cyan-400 to-blue-500 hover:from-cyan-300 hover:to-blue-400 text-slate-950 font-bold rounded-full shadow-[0_4px_20px_rgba(6,182,212,0.4)] disabled:opacity-50 cursor-pointer text-xs uppercase tracking-wider font-extrabold"
        >
          {isRunning ? (
      ...
      {/* 📱 Sticky Bottom Navigation (Mobile & Tablet UI) */}
      <nav className="fixed bottom-0 left-0 right-0 z-40 bg-[#020305]/95 backdrop-blur-md border-t border-white/[0.08] lg:hidden">
        <div className="flex justify-around items-center py-2 px-1">
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center py-1.5 px-3 rounded-lg text-[10px] transition-colors gap-1 cursor-pointer bg-transparent border-0 ${
              activeTab === "Benchmarks" ? "text-cyan-400 font-bold" : "text-slate-500 hover:text-slate-300"
            }`}
          >
          ...
          <button
            onClick={() => setIsSidebarOpen(true)}
            className="flex flex-col items-center justify-center py-1.5 px-3 rounded-lg text-[10px] text-indigo-400 hover:text-indigo-200 transition-colors gap-1 cursor-pointer bg-transparent border-0"
          >
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center py-1.5 px-3 rounded-lg text-[10px] transition-colors gap-1 cursor-pointer bg-transparent border-0 ${
              activeTab === "Research" ? "text-cyan-400 font-bold" : "text-slate-500 hover:text-slate-300"
            }`}
          >
          ...
          <button
            ...
            className="flex flex-col items-center justify-center py-1.5 px-3 rounded-lg text-[10px] text-slate-500 hover:text-cyan-300 transition-colors gap-1 cursor-pointer bg-transparent border-0"
          >
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center py-1.5 px-3 rounded-lg text-[10px] transition-colors gap-1 cursor-pointer bg-transparent border-0 ${
              activeTab === "Settings" ? "text-cyan-400 font-bold" : "text-slate-500 hover:text-slate-300"
            }`}
          >
      ...
      {/* 📱 Mobile Side Drawer Parameters Overlay */}
      <AnimatePresence>
        {isSidebarOpen && (
          <div className="fixed inset-0 z-50 lg:hidden font-sans">
            ...
            <motion.div
              ...
              className="absolute inset-0 bg-[#000000] backdrop-blur-sm"
            />
            ...
            <motion.div
              ...
              className="absolute right-0 top-0 bottom-0 w-full max-w-[340px] bg-[#05070a] border-l border-white/[0.08] p-5 overflow-y-auto flex flex-col gap-6 shadow-[0_0_50px_rgba(0,0,0,0.8)]"
            >
              <div className="flex items-center justify-between pb-4 border-b border-white/[0.05]">
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-cyan-400 animate-pulse" />
                  <span className="text-xs font-bold font-mono text-slate-350 tracking-wider">CALIBRATE REGISTERS</span>
                </div>
                <button
                  type="button"
                  onClick={() => setIsSidebarOpen(false)}
